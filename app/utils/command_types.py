...
SET_COMMANDS: set[Literal
                  ["SADD", "SCARD", "SDIFF", "SDIFFSTORE", "SINTER", "SINTERCARD", "SINTERSTORE", "SUNION", "SUNIONSTORE", "SISMEMBER", "SMEMBERS", "SMOVE", "SREM"]] = {"SADD", "SCARD", "SDIFF", "SDIFFSTORE", "SINTER", "SINTERCARD", "SINTERSTORE", "SUNION", "SUNIONSTORE", "SISMEMBER", "SMEMBERS", "SMOVE", "SREM"}