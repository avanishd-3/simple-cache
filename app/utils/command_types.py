...
STRING_COMMANDS: set[Literal["SET", "GET", "STRLEN"]] = {"SET", "GET", "STRLEN"}
BITMAP_COMMANDS: set[Literal["SETBIT", "GETBIT"]] = {"SETBIT", "GETBIT"}
...
OTHER_COMMANDS: set[Literal["FLUSHDB", "TTL", "EXPIRE"]] = {"FLUSHDB", "TTL", "EXPIRE"}